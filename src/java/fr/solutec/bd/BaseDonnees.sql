...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 09 oct. 2019 à 13:23
...
--
ALTER TABLE `client`
  ADD CONSTRAINT `fk_compte` FOREIGN KEY (`idcompte`) REFERENCES `compte` (`idcompte`) ON DELETE NO ACTION ON UPDATE NO ACTION,
